...
{
    class HotTable extends React.Component<HotTableProps /*Handsontable.Options*/, any>
    {
    }

    interface HotTableProps extends Handsontable.Options/*, React.HTMLProps<HotTable>*/ {
        /**
